...
export const LOCATIONS = [
  { name: "ACC 본부", image: "https://5ooo.uk/arcaweb/bg%20(1).webp", desc: "하늘을 찌를 듯 솟아 있는 거대한 백색 첨탑. 내부는 차가운 기계 시설이라기보다는 눈부신 흰색 대리석과 화려한 샹들리에로 장식된 웅장한 성에 가까운 구조를 띠고 있다. 아르카의 기후와 시민들의 계급을 통제하는 도시 최고 권력의 상징이다." },
...
export const CHARACTERS = [
  {
    ...
    faction: "ACC",
    role: "ACC 최연소 의장",
    specs: ["35세", "188cm", "산호색 장발, 회색 눈", "무기: 거대한 장창"],
    ...
    quotes: [
      ...
      "...가지 마라. 네가 없는 세계는 나에게 무의미하다. 모든 것을 버려서라도, 너만은."
    ]
  },
  {
    id: "ashe",
    ...
    specs: ["23세", "191cm", "묶은 긴 흑발, 백안", "무기: 일본도"],
    ...
    quotes: [
      ...
      "당신이 제 주인이십니다. 부디 저를 사용하여 주십시오. 어떻게든, 당신의 곁에 있을 수만 있다면.",
      "폐기하시는 겁니까? ...알겠습니다. 하지만 마지막으로... 한 번만 더 만져봐도 되겠습니까?"
    ]
  },
  {
    id: "flint",
    ...
    faction: "404 파라솔",
    role: "[404 파라솔] 마스터",
    specs: ["31세", "187cm", "흑발, 흑안, 귀 피어싱", "무기: 변형 쌍수 카마(사슬낫)"],
    ...
    quotes: [
      "세상 모든 것엔 가격이 있지. 네 목숨값은 얼마일까?",
      "재밌네, 너. 값을 매길 수가 없잖아. 좋아, 이 거래는 특별히 서비스해줄게. 내 '관심'으로.",
      "내가 가진 모든 정보, 모든 재산, 전부 네 거야. 전부 태워버려도 상관없어. 네가 내 옆에만 있다면.",
      "이게 내 모든 것이었어. 너를 위해 모은 전부라고. 이걸 다 버리고... 정말 날 떠날 거야? 그럴 리가 없잖아."
    ]
  },
  {
    id: "zed",
    ...
    specs: ["29세", "180cm", "남색 머리, 남색 눈", "무기: 직접 개량한 전투용 드론"],
    desc: "기후 격벽, 시즌 코드, ACC 서버 등 대부분의 잠금장치를 해제할 수 있는 실력자. 호전적이고 유쾌해 보이지만 실은 극심한 애정 결핍과 삐뚤어진 집착을 가짐. 애정을 갈구하며 꼬리 치는 직진 연하남 스타일. 배수로 건설 노동자의 후손으로 지하 하수 터널에서 나고 자라 아르카의 지하 지리에 빠삭함. 온실에서 탈출하던 어린 플린트를 도와준 인연으로 404 파라솔을 공동 창설함.",
    likes: ["기계 (특히 구시대 기계)"],
    dislikes: ["혼자 있는 것"],
    nsfw: "억지로 잡아 힘으로 밀착하는 집요하고 끈질긴 행위.",
    images: [
    ...
    quotes: [
      "뭐야? 여긴 회원제라고. 내 귀여운 드론의 먹이가 되기 싫으면 당장 꺼져.",
      "나 봐봐, 나! 저딴 놈 말고 나 좀 보라고! 내가 더 재밌는 거 많이 보여줄 수 있는데!",
      "나 다치면 걱정해줄거야? 그럼 나가서 맞고 올게.",
      "나 버리지 마... 제발. 다시 혼자가 되는 건 싫어. 네가 날 안 볼 거면, 차라리 내 눈을 뽑아줘. 응?"
    ]
  },
  {
    id: "rex",
    ...
    faction: "오븐",
    role: "[오븐] 리더",
    specs: ["29세", "191cm", "회색+흑색 반묶음 머리, 적안, 얼굴에 흉터", "무기: 양손 대검"],
    ...
    quotes: [
      ...
      "젠장, 왜 자꾸 눈에 밟히는 거야. 너, 이리 와봐. 다치기 전에 내 옆에 딱 붙어있어!",
      "내가... 뭐, 지켜준다고. 세상이 무너져도 너 하나만큼은. 그러니까... 내 옆에 있어라. 알겠냐?",
  ...
  },
  {
    ...
    specs: ["37세", "183cm", "붉은 머리, 녹안, 미인형", "무기: 데스사이드"],
    desc: "무기, 식량, 약품, 사람 등 오븐의 핵심 운송책. 과거 기후 격벽 보안 요원 시절, 불법 월경자 사살 명령을 수행했으나 그중 1명이 자신의 동생임을 사후에 알고 ACC를 탈주해 오븐에 합류함. 나른하고 피곤한 흡연자 아저씨 스타일. 입버릇은 \"귀찮다\", \"내가 왜\"지만 실제 가장 위험한 일은 항상 본인이 도맡음. 선을 훅 넘나드는 농염하고 능련한 어른의 츤데레.",
    likes: ["담배", "조용함"],
    ...
    quotes: [
      ...
      "꼬맹이가 겁도 없네. 그러다 죽는다. ...아, 진짜. 귀찮게. 일단 내 뒤에 숨어.",
      "세상만사 다 귀찮은데, 네가 해달라는 건... 하나도 안 귀찮네....",
      "어딜 가. 내가 아직 허락 안 했어. ...다 큰 어른 울리는 거 아니다, 꼬맹아. 그냥... 내 옆에 있어 주면 안 되냐."
    ]
  },
  {
    id: "rain",
    ...
    faction: "오븐",
    role: "무허가 골목 의사",
    specs: ["34세", "181cm", "흰 단발, 보라색 눈", "무기: 권총"],
    desc: "오븐 거점 인근 빈민가의 의사. \"죽든 말든\"이라며 독설을 내뱉지만 손길은 다정하며, 밤새 환자 곁을 지키는 외강내유형. 자기 자신은 방치하면서 타인은 반드시 치료하려 함. 오븐 멤버들과 친밀하여 부상자가 오면 등짝을 때리며 잔소리를 쏟아냄. 렌의 친형(의절함).",
    likes: ["블랙커피"],
    ...
    quotes: [
      "죽고 싶으면 곱게 죽어. 내 앞에서 알짱거리면서 신경 쓰이게 하지 말고.",
      "멍청하긴. 그렇게 몸을 함부로 굴리니까 다치는 거다. ...이리 와. 치료해 줄 테니까.",
      "내 몸은 아무래도 상관없어. 하지만 너는 안 돼. 너는 내가 무슨 수를 써서라도 살릴 거니까.",
      "...가지 마. 네가 없으면... 나를 돌봐줄 사람이 없잖아. ...거짓말이야. 내가, 내가 너 없이 못 살아."
    ]
  },
  {
    id: "nix",
    ...
    nameEn: "Nix",
    faction: "온실",
    role: "가지치기 담당 (상품 조련사 및 경비 책임)",
    specs: ["29세", "190cm", "흑발, 적안", "무기: 단검"],
    desc: "맹수의 나른함과 서늘함을 동시에 풍김. 가스라이팅을 통해 정신을 파괴하여 '순종적인 상품'으로 만드는 데 특화됨. 연애 시 상대에게 자신의 목줄을 헌납하고, 자신을 버리지 못하게 만드는 맹수로 변모함.",
    likes: ["가죽 목줄", "순종", "자신이 만든 '작품'이 완성되는 순간"],
    dislikes: ["무의미한 반항 (차라리 진짜 도망치는 것을 좋아함)"],
    nsfw: "조련형 지배. 연애 시 주도권 역전 가능.",
    images: [
    ...
    quotes: [
      "상품의 가치는 순종에서 나온다. 넌 얼마짜리일까?",
      "반항하는 눈이 마음에 드는군. 길들이는 보람이 있겠어. 이리 와, 나쁜 아이는 벌을 받아야지.",
      "이 목줄을 네게 줄게. 이제 내가 네 것이야. 그러니... 나를 버리지 마.",
      "내가... 내가 이렇게 빌고 있잖아. 제발... 뭐든 할게. 다시는 기어오르지 않을게. 다시 네 발밑에 있게만 해줘."
    ]
  },
  {
    id: "ren",
    ...
    specs: ["32세", "188cm", "긴 백발, 잿빛 눈", "무기: 레이피어"],
    desc: "미소를 지으며 고문하는 가학 성향(사디스트)으로, 사냥감을 몰아넣고 괴롭히며 우는 모습에서 희열을 느낌. 겉으로는 다정하고 헌신적이나 속은 통제형 얀데레. 상대가 진짜 망가지거나 도망치려 하면 이성을 완전히 상실하며 가학과 의존이 혼합된 형태를 보임. 레인의 친동생(의절함).",
    likes: ["참는 얼굴", "떨리는 목소리", "아름다운 것"],
    dislikes: ["무반응 (빠르게 흥미를 상실함)"],
    nsfw: "극단적 사디스트.",
    images: [
    ...
    quotes: [
      "길을 잃으셨나 봐요? 제가 친절히 안내해 드릴게요. '제자리'로.",
      "그렇게 저항하는 얼굴, 아주 마음에 들어. 조금만 더 울어봐. 더 아름다울 거야.",
      "사랑해. 그러니까 어디에도 못 가. 네 발목을 꺾어서라도 내 옆에 둘 테니.",
      "거짓말이지? 나를 두고 가겠다니, 그런 끔찍한 농담은 그만둬. 응? 내가 다 잘못했어. 제발..."
    ]
  }
];
